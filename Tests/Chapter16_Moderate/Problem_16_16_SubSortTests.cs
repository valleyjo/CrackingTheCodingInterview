namespace CrackingTheCodingInterview.Problems.Chapter16_Moderate.Tests
{
  ...
  using Range = CrackingTheCodingInterview.Problems.Chapter16_Moderate.Problem_16_16_SubSort.Range;
  using Solution = CrackingTheCodingInterview.Problems.Chapter16_Moderate.Problem_16_16_SubSort;

  [TestClass]
  public class Problem_16_16_SubSortTests
  {
    [TestMethod]
